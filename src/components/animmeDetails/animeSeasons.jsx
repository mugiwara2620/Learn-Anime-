...
export function AnimeSeason({ num }) {
    ...
    return (
        <NavLink to={`/anime-details/${num}`} className="relative  snap-center w-64 hover:scale-110 transition-transform  mr-8 py-9 h-full  flex justify-center items-center  rounded-lg ">
