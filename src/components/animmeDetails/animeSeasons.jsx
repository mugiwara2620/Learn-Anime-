...
export function AnimeSeason({ num, animeId }) {
    ...
    return (
        <NavLink
            ...
            className={`relative snap-end focus:will-change-scroll  aspect-auto season-marker  w-64 ${isfocusing && 'scale-110 ml-[10px]'}  transition-transform   py-9 h-full  flex justify-center items-center  rounded-lg `}>
            <div className="overflow-hidden relative    rounded-lg h-56 w-44">
                ...
                <div className="flex items-center w-full justify-center absolute bottom-0 h-[58px] from-black to-transparent bg-gradient-to-t bg-gray-900/10  text-white text-[20px]   ">
                    Attack on titan S{num}
                </div>
            </div>
